...
import com.horrarndoo.zyw.themeswitchdemo.R;
...
public class ThemeConstants {
    public static final String THEME_SHARE_PREFERENCE_KEY_TAG = "theme_share_preference_key_tag";
    public static final String THEME_SHARE_PREFERENCE_KEY_INDEX = "theme_share_preference_key_index";
